...
export class TraderData {
  ...
  public registerProfileImage(): void {
    const imageFilepath = `./${this.ref.preSptModLoader.getModPath(
      this.mod
    )}res`;
  ...
  public createPlateFluidAssort(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total plates have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public createMedsFluidAssort(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total meds have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public createGearFluidAssort(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total pieces of gear have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public createAmmoFluidAssort(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total types of ammo have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public createItemsFluidAssort(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total items have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public createWeaponFluidAssort(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total weapons have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public createSpecFluidAssort(debugLogging: boolean): void {
      ...
      if (this.ref.probHelper.rollChance(10, 100)) {
        ...
        try {
          ...
          this.logger.logError(
            `Error loading Special Items from Fluid Assort Trader Generator: ${error}`
          );
        }
      }
    });
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total special items have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public addStaticItems(debugLogging: boolean): void {
    ...
    if (debugLogging) {
      this.logger.log(
        `${count} total static items have been added`,
        LogTextColor.GREEN
      );
    }
    //#endregion
  ...
  public addWeaponPresets(debugLogging: boolean): void {
    ...
    try {
      ...
      this.logger.log(
        `Error loading weapon preset => ${error}, skipping.`,
        LogTextColor.RED
      );
    }
    //#endregion
  ...
  public addGearPresets(debugLogging: boolean): void {
    ...
    try {
      ...
      this.logger.log(
        `Error loading gear preset => ${error}, skipping.`,
        LogTextColor.RED
      );
    }
    //#endregion
  ...
  public addCustomPresets(debugLogging: boolean): void {
    ...
    if (this.ref.probHelper.rollChance(20, 100)) {
      try {
        ...
        this.logger.logError(
          `Error loading Custom Presets from Fluid Assort Trader Generator: ${error}`
        );
      }
    }
  ...
  static traderRepLogic(
    ...
    try {
      ...
      logger.logError(
        `Error modifying Trader Rep on Successful Raid Exfil: ${error}`
      );
    }
  }
