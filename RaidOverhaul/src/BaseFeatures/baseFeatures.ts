...
export class AssortedBullshit {
  ...
  public raidChanges(modConfig: configFile): void {
    ...
    if (modConfig.Raid.ReduceFoodAndHydroDegrade.Enabled) {
      this.globals().Health.Effects.Existence.EnergyDamage =
    ...
    if (modConfig.Raid.ChangeAirdropValues.Enabled) {
      this.ref.tables.locations[
        "bigmap"
      ].base.AirdropParameters[0].PlaneAirdropChance =
      ...
      this.ref.tables.locations[
        ...
        modConfig.Raid.ChangeAirdropValues.Streets;
      this.ref.tables.locations[
        "sandbox"
      ].base.AirdropParameters[0].PlaneAirdropChance =
        modConfig.Raid.ChangeAirdropValues.GroundZero;
      this.ref.tables.locations[
        "sandbox_high"
      ].base.AirdropParameters[0].PlaneAirdropChance =
        modConfig.Raid.ChangeAirdropValues.GroundZero;
  ...
  public weightChanges(modConfig: configFile): void {
    if (modConfig.WeightChanges.Enabled) {
      this.globals().Stamina.BaseOverweightLimits.x *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.BaseOverweightLimits.y *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.WalkOverweightLimits.x *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.WalkOverweightLimits.y *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.WalkSpeedOverweightLimits.x *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.WalkSpeedOverweightLimits.y *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.SprintOverweightLimits.x *=
        modConfig.WeightChanges.WeightMultiplier;
      this.globals().Stamina.SprintOverweightLimits.y *=
        modConfig.WeightChanges.WeightMultiplier;
    }
  }
  //#endregion
  ...
  public itemChanges(modConfig: configFile): void {
    ...
    const uhPockets =
      this.ref.tables.templates.items["65e080be269cbd5c5005e529"];
  ...
  public traderTweaks(modConfig: configFile): void {
    ...
    if (modConfig.Trader.LL1Items) {
      for (const item in this.ref.tables.traders["66f0eaa93f6cc015bc1f3acb"]
        .assort.loyal_level_items) {
        this.ref.tables.traders[
          "66f0eaa93f6cc015bc1f3acb"
        ].assort.loyal_level_items[item] = 1;
      }
    }
  ...
  public lootChanges(modConfig: configFile): void {
    ...
    const markedRoomCustoms =
      this.ref.tables.locations.bigmap.looseLoot.spawnpoints;
    const markedRoomReserve =
      this.ref.tables.locations.rezervbase.looseLoot.spawnpoints;
    const markedRoomStreets =
      this.ref.tables.locations.tarkovstreets.looseLoot.spawnpoints;
    const markedRoomLighthouse =
      this.ref.tables.locations.lighthouse.looseLoot.spawnpoints;
  ...
  public weatherChangesAllSeasons(modConfig: configFile) {
    ...
    if (
      (modConfig.Seasons.AllSeasons && modConfig.Seasons.WinterWonderland) ||
      (modConfig.Seasons.NoWinter && modConfig.Seasons.WinterWonderland) ||
      (modConfig.Seasons.SeasonalProgression &&
        modConfig.Seasons.WinterWonderland) ||
      (modConfig.Seasons.NoWinter && modConfig.Seasons.SeasonalProgression) ||
      (modConfig.Seasons.NoWinter && modConfig.Seasons.AllSeasons) ||
      (modConfig.Seasons.SeasonalProgression && modConfig.Seasons.AllSeasons)
    ) {
      this.logger.log(
  ...
  public weatherChangesWinterWonderland(modConfig: configFile) {
    ...
    if (
      ...
      weatherConfig.overrideSeason = Season.WINTER;
      this.logger.log(
        `Snow is active. It's a whole fuckin' winter wonderland out there.`,
